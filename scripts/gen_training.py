for training_type in ["noise","scale","scale_vae"]:
    ...
    command+=f"main.py --save_dir {training_type} --repo_id jlbaker361/{training_type} --batch_size 4 --val_interval 10 --training_type {training_type} --limit -1 --epochs 100 --gradient_accumulation_steps 8 "
    print(command)